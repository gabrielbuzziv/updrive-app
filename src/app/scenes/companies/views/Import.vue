<template>
    <el-dialog title="Importar empresas" :visible.sync="visible">
        <div class="alert alert-info">
            <h3>Importar suas empresas para o UP Drive</h3>

            <p>
                Baixe nossa planilha padrão, preencha os dados da empresa e envie para nós.
            </p>
        </div>
            ...
            <div class="text-center block margin-top-30 margin-bottom-30">
                ...
                <label class="upload-button">
                    ...
                    <span class="btn btn-primary btn-rounded" :class="{ 'btn-secondary': valid }">
                        ...
                        <span v-else>Enviar planilha de empresas</span>
                    </span>
                </label>
            </div>
...
<script type="text/babel">
    ...
    export default {
        ...
        computed: {
            ...
            downloadImportSheet () {
                return `${window.env.API_URL}/companies/import/download/?token=${this.token}`
            },
        ...
        mounted () {
            this.$root.$on('import::companies', () => this.load())
        },

        beforeDestroy () {
            this.$root.$off('import::companies')
        }
    }
</script>
